...
namespace geom
{
    ...
    vector_ operator * (double a, const vector_ &v)
    {
        return vector_ {v.x * a, v.y * a, v.z * a};
    }
    ...
    struct line_
    {
        ...
        vector_ line_intersect (const line_ &l) const;
    ...
    struct line_segment_
    {
        ...
        bool content_vec (const vector_ &v) const;
    ...
    struct triangle_
    {
        ...
        triangle_ (const vector_ &A, const vector_ &B, const vector_ &C)
        {
            line_segment_ ls1 {A, B}, ls2{B, C};

            if (ls1.content_vec(C))
            {
                a = A;
                b = C;
                c = B;
...
}//TODO: check when line_segment is in surface
